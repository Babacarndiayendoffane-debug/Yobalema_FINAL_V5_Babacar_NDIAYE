...
async function main() {
  ...
  await prisma.driver.upsert({
    ...
    update: { status: DriverStatus.ONLINE, lat: 14.151, lng: -16.0726, vehicleType: 'MOTO', vehiclePlate: 'KA-0001-AA', verificationStatus: VerificationStatus.VERIFIED },
    create: { userId: driver.id, status: DriverStatus.ONLINE, lat: 14.151, lng: -16.0726, vehicleType: 'MOTO', vehiclePlate: 'KA-0001-AA', verificationStatus: VerificationStatus.VERIFIED }
  });
