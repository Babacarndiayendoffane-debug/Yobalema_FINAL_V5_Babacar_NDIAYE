...
// Simplified outer ring of Région de Kaolack, derived from a published Senegal
// first-level administrative GeoJSON (ISO-3166-2: SN-KL). WGS84 lon/lat order.
// Keep the bounding box only as a fast pre-check; final validation uses the polygon.
